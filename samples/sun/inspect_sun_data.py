...
# # Mask R-CNN - Inspect Sun Training Data
# 
...
# ## Configurations
# 
# Configurations are defined in sun.py

# In[ ]:


config = sun.SunConfig()
SUN_DIR = ROOT_DIR + "dataset/sun/SUNRGBD/train"  # TODO: update this path
...
dataset = sun.SunDataset()
dataset.load_sun(SUN_DIR, "train")
...
# https://github.com/matterport/Mask_RCNN/issues/47
